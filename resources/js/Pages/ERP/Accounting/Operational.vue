    ...
    <div class="space-y-5">
      <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <div class="mt-2 flex items-center justify-between gap-3">
          <h1 class="text-3xl font-bold tracking-tight">Operational</h1>
        ...
        <p class="mt-2 text-sm text-base-content/70">Pencatatan biaya operasional umum (tanpa project) atau per project.</p>
      </div>
