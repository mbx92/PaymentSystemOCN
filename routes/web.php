...
Route::middleware(['auth', 'throttle:120,1'])->group(function () {
    ...
    Route::middleware('role:admin|manajer')->group(function () {
        ...
        Route::post('erp/sales/transactions/{posSale}/close-reopen', [ERPSalesController::class, 'closeReopenPosTransaction'])->name('erp.sales.pos.transactions.close-reopen');
    ...
    Route::middleware('role:admin')->group(function () {
        ...
        Route::post('erp/admin/data-import/master-products/normalize-svc-services', [ERPAdministrationMasterDataController::class, 'normalizeSvcSkuProducts'])->name('erp.admin.data-import.master-products.normalize-svc-services');
