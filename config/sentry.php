...
return [
    ...
    // GlitchTip is Sentry-compatible — point GLITCHTIP_DSN to your GlitchTip project DSN.
    // Only active in production (APP_ENV=production) to avoid tracking dev errors.
    'dsn' => env('APP_ENV') === 'production'
        ? env('GLITCHTIP_DSN', env('SENTRY_LARAVEL_DSN', env('SENTRY_DSN')))
        : null,
    ...
    // Traces disabled by default (error tracking only). Set SENTRY_TRACES_SAMPLE_RATE to e.g. 0.1 to enable.
